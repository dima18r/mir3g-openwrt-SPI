...
// отключаем PCIe, если у вас сгорели чипы беспроводной сети.
// в моем случае во-круг чипа 2.4Ггц плата потемнела, из-за чего загрузка системы зависала, при обращении к чипам (pcie0 и pcie1)
&pcie {
\tstatus = "disabled";
};
